...
const RecentAddedProductsPage = (props) => {
  ...
  return (
    <>
      <div className="recentaddedpageName">
        <p>Recent Added</p>
      </div>
      <div className="recentaddedpage-wrraper">

        <FilterCategory />

        <div className="recentaddedpagemain">
          {currentProducts.map((item) => {
            if (props.categories === item.categories) {
              return (
                <div key={item.id} className="recentaddedpage-container">
                  <div className="recentaddedpage-cart">
                    <div className="recentaddedpage-image">
                      <Link to={`/ProductDisplay/${item.id}`}>
                        <img src={item.img} alt={item.name} />
                      </Link>
                    </div>
                    <div className="recentaddedpage-textcontents">
                      <Link to={`/ProductDisplay/${item.id}`}><h1>{item.name}</h1></Link>
                      <h3>By: {item.byowner}</h3>
                      <div className="recentaddedpage-pricess">
                        <h4>Rs: {item.price}</h4>
      ...
      <div className="Recentaddedpagination">
...
export default RecentAddedProductsPage;