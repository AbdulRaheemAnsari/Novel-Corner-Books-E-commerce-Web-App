...
const BestSellingProPage = (props) => {
  ...
  return (
    <>
      <div className="bestsellingpageName">
        <p>Best Selling</p>
      </div>
      <div className="bestsellingpage-wrraper">

        <FilterCategory />



        <div className="bestsellingpagemain">
          {currentProducts.map((item) => {
            if (props.categories === item.categories) {
              return (
                <div key={item.id} className="bestsellingpage-container">
                  <div className="bestsellingpage-cart">
                    <div className="bestsellingpage-image">
                      <Link to={`/ProductDisplay/${item.id}`}>
                        <img src={item.img} alt={item.name} />
                      </Link>
                    </div>
                    <div className="bestsellingpage-textcontents">
                      <Link to={`/ProductDisplay/${item.id}`}><h1>{item.name}</h1></Link>
                      <h3>By: {item.byowner}</h3>
                      {/* <div className="bestsellingpage-reviews">
                        <TiStarFullOutline />
                        <TiStarFullOutline />
                        <TiStarFullOutline />
                        <TiStarFullOutline />
                      ...
                      <div className="bestsellingpage-pricess">
                        <h4>Rs: {item.price}</h4>
      ...
      <div className="Bestsellingpagination">
...
export default BestSellingProPage;